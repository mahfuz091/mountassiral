    ...
    <header className='header'>
      ...
      <div className='header-left '>
        <div className='hidden lg:flex lg:relative'>
          ...
          <button className='primary-btn'>Monnaie</button>
          <button className='primary-btn'>Achat</button>

          <div className='flex gap-[15px] ml-[102px]'>
            <div className='relative'>
              <img className='w-[49px] h-[49px]' src={notification} alt='' />
              <svg
                xmlns='http://www.w3.org/2000/svg'
                width='10'
                height='11'
              ...
              >
                <circle cx='4.84094' cy='5.45105' r='4.80505' fill='#F06D23' />
              </svg>
            </div>
